...
## Irminsul FastDB Fork Notice

This repository is a performance-focused fork of
[QuiltServerTools/Ledger](https://github.com/QuiltServerTools/Ledger). The
original project is developed by the QuiltServerTools contributors and is
licensed under LGPL-3.0. This fork keeps the original license and source
availability requirements.

Thanks to the original Ledger authors and contributors for the Fabric logging
tool this work is based on. The FastDB backend and related rollback/query
performance work are experimental fork changes and are not an official upstream
release.

FastDB development notes and validation results are documented in
