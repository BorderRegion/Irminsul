...
Ledger is developed by the QuiltServerTools contributors and is licensed under
the GNU Lesser General Public License version 3.0. This fork keeps the original
license file and continues to distribute the modified source under LGPL-3.0.
...
QuiltServerTools release unless explicitly accepted or published by the
upstream project.
